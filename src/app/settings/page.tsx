...
import { Trash2, Plus, ArrowRight, Pencil, Check, X } from "lucide-react";
...
export default function SettingsPage() {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Report Format Settings Section */}
            <Card>
                <CardHeader>
                    <CardTitle>Report Format Settings</CardTitle>
                    <CardDescription>Configure Excel report formatting: sort order, filters, and header colors.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Link href="/settings/reports">
                        <Button variant="outline">
                            Configure Report Settings <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                    </Link>
                </CardContent>
            </Card>
